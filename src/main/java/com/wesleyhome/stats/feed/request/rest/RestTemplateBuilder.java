package com.wesleyhome.stats.feed.request.rest;
...
/**
 * Builder that can be used to configure and create a {@link RestTemplate}. Provides convenience
 * methods to register {@link #messageConverters(HttpMessageConverter...) converters}, {@link
 * #errorHandler(ResponseErrorHandler) error handlers} and {@link #uriTemplateHandler(UriTemplateHandler)
 * UriTemplateHandlers}. <p> By default the built {@link RestTemplate} will attempt to use the most
 * suitable {@link ClientHttpRequestFactory}, call {@link #detectRequestFactory(boolean)
 * detectRequestFactory(false)} if you prefer to keep the default. In a typical auto-configured
 * Spring Boot application this builder is available as a bean and can be injected whenever a {@link
 * RestTemplate} is needed.
 *
...
public class RestTemplateBuilder {
     ...
     *
     * @param customizers any {@link RestTemplateCustomizer RestTemplateCustomizers} that should be
     *                    applied when the {@link RestTemplate} is built
     */
    ...
    /**
     * Set if the {@link ClientHttpRequestFactory} should be detected based on the classpath. Default
     * if {@code true}.
     *
     * @param detectRequestFactory if the {@link ClientHttpRequestFactory} should be detected
     ...
     * RootUriTemplateHandler} for details.
     *
    ...
    /**
     * Set the {@link HttpMessageConverter HttpMessageConverters} that should be used with the {@link
     * RestTemplate}. Setting this value will replace any previously configured converters.
     *
    ...
    /**
     * Add additional {@link HttpMessageConverter HttpMessageConverters} that should be used with the
     * {@link RestTemplate}.
     *
    ...
    /**
     * Set the {@link HttpMessageConverter HttpMessageConverters} that should be used with the {@link
     * RestTemplate} to the default set. Calling this method will replace any previously defined
     * converters.
     *
     * @return a new builder instance
     * @see #messageConverters(HttpMessageConverter...)
    ...
    /**
     * Set the {@link ClientHttpRequestInterceptor ClientHttpRequestInterceptors} that should be used
     * with the {@link RestTemplate}. Setting this value will replace any previously defined
     * interceptors.
     *
    ...
    /**
     * Add additional {@link ClientHttpRequestInterceptor ClientHttpRequestInterceptors} that should
     * be used with the {@link RestTemplate}.
     *
    ...
    /**
     * Set the {@link ClientHttpRequestFactory} class that should be used with the {@link
     * RestTemplate}.
     *
    ...
    /**
     * Set the {@link ClientHttpRequestFactory} that should be used with the {@link RestTemplate}.
     *
     * @param requestFactory the request factory to use
     * @return a new builder instance
     */
    ...
    /**
     * Set the {@link ResponseErrorHandler} that should be used with the {@link RestTemplate}.
     *
    ...
    /**
     * Add HTTP basic authentication to requests. See {@link BasicAuthorizationInterceptor} for
     * details.
     *
    ...
    /**
     * Set the {@link RestTemplateCustomizer RestTemplateCustomizers} that should be applied to the
     * {@link RestTemplate}. Customizers are applied in the order that they were added after builder
     * configuration has been applied. Setting this value will replace any previously configured
     * customizers.
     *
    ...
    /**
     * Add {@link RestTemplateCustomizer RestTemplateCustomizers} that should be applied to the {@link
     * RestTemplate}. Customizers are applied in the order that they were added after builder
    ...
    /**
     * Sets the connect timeout in milliseconds on the underlying {@link ClientHttpRequestFactory}.
     *
    ...
    /**
     * Sets the read timeout in milliseconds on the underlying {@link ClientHttpRequestFactory}.
     *
    ...
    /**
     * Build a new {@link RestTemplate} instance of the specified type and configure it using this
     * builder.
     *
